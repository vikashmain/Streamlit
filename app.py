...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Sentiment"): 
        ...
        b = 40
        if a_value < b:
            st.warning(f"This person talks mostly negative ({a_value:.2f}%), be careful")

        st.write(f"Positive % of messages of {selected_user} is {a_value:.2f} %")
        st.write("Note: Neutral Messages are those which don't sense to be negative but closer to positive.")
